    ...
    public async Task<AgremiacaoDto?> Alterar(int id, AlterarAgremiacaoDto dto)
    {
        ...
        if (await _agremiacaoRepository.UnitOfWork.Commit())
        {
            RegistroDeEventos.Adicionar(new RegistroDeEvento
            {
                ...
                ComputadorId = ObterIp(),
                Descricao =
                    $"Sigla={agremiacaoInicial.Sigla};<br>Sigla={agremiacao.Sigla};Nome={agremiacaoInicial.Nome};<br>Nome={agremiacao.Nome};Fantasia={agremiacaoInicial.Fantasia};<br>Fantasia={agremiacao.Fantasia};Responsavel={agremiacaoInicial.Responsavel};<br>Responsavel={agremiacao.Responsavel};Representante={agremiacaoInicial.Representante};<br>Representante={agremiacao.Representante};DataFiliacao={agremiacaoInicial.DataFiliacao};<br>DataFiliacao={agremiacao.DataFiliacao};DataNascimento={agremiacaoInicial.DataNascimento};<br>DataNascimento={agremiacao.DataNascimento};Cep={agremiacaoInicial.Cep};<br>Cep={agremiacao.Cep};Endereco={agremiacaoInicial.Endereco};<br>Endereco={agremiacao.Endereco};Bairro={agremiacaoInicial.Bairro};<br>Bairro={agremiacao.Bairro};Complemento={agremiacaoInicial.Complemento};<br>Complemento={agremiacao.Complemento};Cidade={agremiacaoInicial.Cidade};<br>Cidade={agremiacao.Cidade};Estado={agremiacaoInicial.Estado};<br>Estado={agremiacao.Estado};Pais={agremiacaoInicial.Pais};<br>Pais={agremiacao.Pais};Telefone={agremiacaoInicial.Telefone};<br>Telefone={agremiacao.Telefone};Email={agremiacaoInicial.Email};<br>Email={agremiacao.Email};Cnpj={agremiacaoInicial.Cnpj};<br>Cnpj={agremiacao.Cnpj};InscricaoMunicipal={agremiacaoInicial.InscricaoMunicipal};<br>InscricaoMunicipal={agremiacao.InscricaoMunicipal};InscricaoEstadual={agremiacaoInicial.InscricaoEstadual};<br>InscricaoEstadual={agremiacao.InscricaoEstadual};DataCnpj={agremiacaoInicial.DataCnpj};<br>DataCnpj={agremiacao.DataCnpj};DataAta={agremiacaoInicial.DataAta};<br>DataAta={agremiacao.DataAta};Foto={agremiacaoInicial.Foto};<br>Foto={agremiacao.Foto};AlvaraLocacao={agremiacaoInicial.AlvaraLocacao};<br>AlvaraLocacao={agremiacao.AlvaraLocacao};Estatuto={agremiacaoInicial.Estatuto};<br>Estatuto={agremiacao.Estatuto};ContratoSocial={agremiacaoInicial.ContratoSocial};<br>ContratoSocial={agremiacao.ContratoSocial};DocumentacaoAtualizada={agremiacaoInicial.DocumentacaoAtualizada};<br>DocumentacaoAtualizada={agremiacao.DocumentacaoAtualizada};Regiao={regiaoInicial?.Descricao};<br>Regiao={regiao?.Descricao};Anotacoes={agremiacaoInicial.Anotacoes};<br>Anotacoes={agremiacao.Anotacoes};",
                ClienteId = Convert.ToInt32(_httpContextAccessor.HttpContext?.User.ObterClienteId()),
                TipoOperacaoId = 5,
                UsuarioNome = _httpContextAccessor.HttpContext?.User.ObterNome(),
                AdministradorNome = null,
