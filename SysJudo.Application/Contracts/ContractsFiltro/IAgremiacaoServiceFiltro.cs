...
namespace SysJudo.Application.Contracts.ContractsFiltro;

public interface IAgremiacaoServiceFiltro
{
    Task<List<AgremiacaoDto?>> Filtrar(List<FiltragemAgremiacaoDto> dto, List<Agremiacao> agremiacoes = null,
        int tamanho = 0, int aux = 0);
